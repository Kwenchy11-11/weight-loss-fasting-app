  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FFFBF7] p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-10 w-72 h-72 bg-[#E8B4B8] rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
        <div className="absolute bottom-20 left-10 w-96 h-96 bg-[#D4A574] rounded-full mix-blend-multiply filter blur-3xl opacity-15"></div>
      </div>
      ...
      <Card className="w-full max-w-md luxury-card relative z-10">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-[#6B5B4F]">Or sign up with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-[#2C1810]">Name (Optional)</Label>
              <Input
                id="name"
                type="text"
            ...
            <div className="space-y-2">
              <Label htmlFor="confirmPassword" className="text-[#2C1810]">Confirm Password</Label>
              <Input
                id="confirmPassword"
                type="password"
        ...
        <CardFooter className="flex flex-col space-y-2">
          <div className="text-sm text-center text-[#6B5B4F]">
            ...
            <Link href="/login" className="text-[#D4A574] hover:text-[#B8935F] font-medium hover:underline">
              Sign in
            </Link>
          </div>
        </CardFooter>
